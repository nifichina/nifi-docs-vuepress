...
**Database Type**                         | Generic   |<li>Generic</li><li>Oracle</li><li>Oracle 12+ </li><li>MS SQL 2012+ </li><li>MS SQL 2008</li><li>MySQL </li>                                                             | 数据库的类型，用于生成特定于数据库的代码。在许多情况下，泛型类型就足够了，但是有些数据库(如Oracle)需要定制SQL子句。                                                                                                                                                                                                                                                      
